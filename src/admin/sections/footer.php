...
<main class="max-w-215 mx-auto px-6 py-12">
    ...
    <header class="mb-10">
        <h1 class="text-2xl font-semibold tracking-tight">Edit: Footer</h1>
        <p class="text-xs text-[#8b949e] mt-1">Update footer text, copyright, credits, and social media links.</p>
    </header>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
        ...
        <div id="card-credits" class="bg-[#161b22] border border-[#30363d] rounded-xl p-6 transition-all hover:border-[#444c56]">
            <div class="animate-pulse h-10 bg-[#21262d] rounded-md"></div>
        </div>

        <div id="card-copyright" class="md:col-span-2 bg-[#161b22] border border-[#30363d] rounded-xl p-6 transition-all hover:border-[#444c56]">
            <div class="animate-pulse h-10 bg-[#21262d] rounded-md"></div>
        </div>
    ...
    <!-- SOCIAL LINKS -->
    <p class="text-[11px] uppercase tracking-[0.15em] text-[#8b949e] mb-4 font-bold">Social Media Links (Full CRUD)</p>
    <div id="card-socials" class="bg-[#161b22] border border-[#30363d] rounded-xl p-6 transition-all hover:border-[#444c56]">
