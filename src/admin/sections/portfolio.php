...
<main class="max-w-215 mx-auto px-6 py-12">
    ...
    <header class="mb-10">
        <h1 class="text-2xl font-semibold tracking-tight">Edit: Portfolio</h1>
        <p class="text-xs text-[#8b949e] mt-1">Add, update, or remove portfolio projects.</p>
    </header>

    <!-- PORTFOLIO PROJECTS -->
    <p class="text-[11px] uppercase tracking-[0.15em] text-[#8b949e] mb-4 font-bold">Portfolio Projects (Full CRUD)</p>

    <div id="card-projects" class="bg-[#161b22] border border-[#30363d] rounded-xl p-6 hover:border-[#444c56] transition-all">
...
<script type="module" src="../../js/pages/portfolio.js"></script>
</body>
</html>